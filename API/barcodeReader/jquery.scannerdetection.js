...
(function($){
    $.fn.scannerDetection=function(options){
        ...
        this.each(function(){
            ...
            $self.data('scannerDetection',{options:options}).unbind('.scannerDetection')    
                .bind('keydown.scannerDetection',function(e){
                    ...
                    // So need that to check endChar and startChar (that is often tab or enter) and call keypress if necessary
                        ...
                        (firstCharTime && options.endChar.indexOf(e.which)!==-1)
                         || 
                    ...
                    if(options.onKeyDetect)
                        options.onKeyDetect.call(self,e);
