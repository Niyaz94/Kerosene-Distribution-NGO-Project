<?php
    ...
    if (isset($_POST["type"]) || isset($_GET["type"])){
        ...
        if ($_POST["type"] == "acceptDonation"){
            ...
            $have_round = $database->return_data2(array(
            ...
            $donation_id = $database->insert_data2("donation",array(
                "DOTFMYFORID"=>$FMYID_UIZP,
                "PageName"=>$PageName,
                "DOTRNDFORID"=>$round["RNDID"]
            ));   
            if ($donation_id>0) {	
